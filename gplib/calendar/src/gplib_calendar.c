...
//================================================================//
//#define MAY_01TH_2016        2457875 //2017-05-01
#define SYSTEM_DATE_INIT	   2457875 //2017-05-01

INT32U LAST_JULIAN_DATE = SYSTEM_DATE_INIT; //初始日期为： 2016-05-01
...
static INT32U cal_day_get(void)
{
	...
	if(r_time.rtc_day == 0) {
		...
		LAST_JULIAN_DATE = SYSTEM_DATE_INIT;
	}
