...
// Motion detection
#define MD_STOP_TIME					60*2	//2分钟		// when MD_STOP_TIME seconds detect no motion then stop video record
//motion detect sensitive
#define LOW								300
#define MEDIUM							150
#define HIGH							70
#define MD_SENSITIVE					90  //0x40  //移动侦测灵敏度
...
// GPIO
    ...
    //#define	VIDEO_KEY						IO_D11//IO_C13//IO_B5
	/*
	#define	CAPTURE_KEY					IO_B4//IO_C14//IO_B4
	#define	RECORD_KEY						IO_C13//IO_C14//IO_B4
	*/
    #define	MODE_KEY						IO_F15

	#define POWER_ENABLE_PIN                IO_C12
	#define CHARGE_DETECTION_PIN            IO_D13
	
	//#define VIDEO_KEY_ACTIVE                1
	/*
	#define CAPTURE_KEY_ACTIVE              0
	#define RECORD_KEY_ACTIVE				0
	*/
	#define MODE_KEY_ACTIVE                 1

    #define SCCB_SCL						IO_E2// Sensor I2C clock pin
    #define SCCB_SDA      				    IO_E3// Sensor I2C data pin	
...
//====================Liuxi modified in 2015-01-15==================================    
    ...
    #define LED1							IO_A7 //IO_D10	blue
    #define LED2							IO_A6 //IO_D13 red
	#define LED3							IO_F15 //IO_D13 green
    #define IR_LED1							IO_F15 //ir led //green
...
//----------------------------------------------------------------------------------    
    ...
    #define AUTO_SAVE_VIDEO_TIME            	8 		   //自动保存录像时间 
    ...
    #define  VIDEO_SAVE_LED_SWITCH				CUSTOM_ON   //录像时快闪灯	
    #define  C_IDLE_SLEEP						128/PERI_TIME_INTERVAL_AD_DETECT*120         //120秒自动关机
    
    #define  CHARGING_WHILE_ENCORD_VIDEO        0
    #define  OSD_SWITCH_MODE 				    0//=1, 可能过 time.txt （Y）设置显示OSD水印
//====================Liuxi modified in 2015-01-15==================================    

    #define CDSP_IQ							GPCV1248_JVIN_V1_0//GPCV1248_C6_V2_0	
    #define PRODUCT_NUM                     7636
	#define PRODUCT_DATA                    20170922
	#define PROGRAM_VERSION_NUM             10	//0
